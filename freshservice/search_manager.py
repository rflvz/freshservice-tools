...
class SearchManager:
    ...
    def export_results(self, assets, output_file):
        ...
        if output_file.endswith('.xlsx'):
            ...
            # Definir el orden exacto de las columnas que queremos
            ordered_columns = ["display_id", "asset_tag", "name", "department_id", "user_id", "state"]
            ...
            # Añadir cualquier columna adicional que no esté en nuestro orden predefinido
